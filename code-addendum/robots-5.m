...
observations = [2,2,2,1,2] #plausible observations: [2,2,2,1,2], [3,3,2,0,2], [2,2,2,2,2], [2,2,1,1,2]
...
tic();
property_probability = 0;
encoded_state_trajectory = [3,3,3,3,3];
...
printf("\n\nproperty 2: having lost connectivity during the last move\n");
observations = [2,2,2,1,0] #plausible observations: [2,2,2,1,0], [3,3,2,1,0], [2,2,2,2,0], [2,1,1,1,0]
encoded_observations = observations.+1;
time_horizon = length(observations);
...
tic();
property_probability = 0;
updating_state_trajectory = [2,2,2,2];
